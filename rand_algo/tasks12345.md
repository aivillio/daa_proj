...
---
Number of elements in array = n</br>
Number of comparisons performed = X</br>
For each pair 1 <= i < j <= n, X<sub>ij</sub> is 1 if elements i and j are compared and is 0 otherwise.</br>
<img src="images/xij.png"/></br>
Taking expectation and using linearity:</br>
<img src="images/exij.png"/></br>
Since there are j − i + 1 elements, the probability of one of them being chosen as pivot and both of them being compared is 2/(j-i+1).</br>
<img src="images/probcomp.png"/></br>
<img src="images/calccomp.png"/></br>
Finally:</br>
<img src="images/finalcomp.png"/></br>
# Task 2
...
Take node x. D<sub>x</sub> denotes its depth.
...
When y>x:</br>
<img src="images/ygtx.png"/></br>
When x>y:</br>
<img src="images/yltx.png"/></br>
Finding Expectation:</br>
<img src="images/heightproof.png"/></br>
...
# Task 4
### Implement Treap insert, delete, and search operations. Derive the expected time complexity of each.
---
